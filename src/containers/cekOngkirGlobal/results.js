...
const Results = ({route, navigation}) => {
  ...
  const getResult = () => {
    fetch (
      `https://api.rajaongkir.sipondok.com/v1/intern/tarif?dari=${route.params.ProvinsiID}&ke=${route.params.NegaraIDTujuan}&berat=${route.params.berat}&kurir=${route.params.kurirValue}`
    )
